...
class BootStrap {
	...
	def createTestRecords(){
		...
		jmsService.send(queue:'PFM_Event','event:PatientAdmittedWithBed,timestamp:2012-07-22/15-40-00,Location_ID:R105,Unit_ID:CW,Patient_ID:Pa111111')
		jmsService.send(queue:'PFM_Event','event:WaitForTransport,timestamp:2012-07-22/15-41-00,Unit_ID:CW,Patient_ID:Pa111111')
