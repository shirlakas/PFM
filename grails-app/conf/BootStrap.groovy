...
class BootStrap {
	...
	def createTestRecords(){
		...
		jmsService.send(queue:'PFM_Event','event:WaitForConsultation1,timestamp:2011-11-11/04-00-00,Patient_ID:Pa123456')
		jmsService.send(queue:'PFM_Event','event:ConsultationStarted1,timestamp:2011-11-11/04-20-00,Provider_ID:Phy777777,Patient_ID:Pa123456')
		jmsService.send(queue:'PFM_Event','event:ConsultationCompleted1,timestamp:2011-11-11/04-40-00,Provider_ID:Phy777777,Patient_ID:Pa123456')
		jmsService.send(queue:'PFM_Event','event:ConsultationStarted1,timestamp:2011-11-11/04-20-00,Provider_ID:Phy777777,Patient_ID:Pa123456')
		jmsService.send(queue:'PFM_Event','event:ConsultationCompleted1,timestamp:2011-11-11/04-40-00,Provider_ID:Phy777777,Patient_ID:Pa123456')
		jmsService.send(queue:'PFM_Event','event:WaitForConsultation1,timestamp:2011-11-11/04-50-00,Patient_ID:Pa123456')
		jmsService.send(queue:'PFM_Event','event:ConsultationStarted2,timestamp:2011-11-11/05-40-00,Provider_ID:Phy777777,Patient_ID:Pa123456')
		jmsService.send(queue:'PFM_Event','event:ConsultationCompleted2,timestamp:2011-11-11/06-00-00,Provider_ID:Phy777777,Patient_ID:Pa123456')
		jmsService.send(queue:'PFM_Event','event:PatientAdmittedWithNoBed,timestamp:2011-11-11/06-35-00,Patient_ID:Pa123456')
		jmsService.send(queue:'PFM_Event','event:WaitForBed,timestamp:2011-11-11/06-35-00,Unit_ID:CCU2,Patient_ID:Pa123456')
		jmsService.send(queue:'PFM_Event','event:PatientArrivedInBed,timestamp:2011-11-11/06-30-00,Bed_ID:Bed207,Unit_ID:CCU1,Patient_ID:Pa111111')
		
		//jmsService.send(queue:'PFM_Web_Event',[event:"PatientArrivedInBed",timestamp:"2011-11-11/06-30-00",Bed_ID:"Bed207",Unit_ID:"CCU1",Patient_ID:"Pa111111"])
		...
		jmsService.send(queue:'PFM_Event','event:PatientRegistered,timestamp:2011-11-11/05-40-00,Room_ID:ED2,Patient_ID:Pa123457')
		jmsService.send(queue:'PFM_Event','event:ConsultationStarted1,timestamp:2011-11-11/06-20-00,Provider_ID:Phy777777,Patient_ID:Pa123457')
...
//		jmsService.send(queue:'PFM_Event','event:WaitForConsultation1,timestamp:2011-11-11/04-00-00,Patient_ID:Pa234567')
//		jmsService.send(queue:'PFM_Event','event:ConsultationStarted1,timestamp:2011-11-11/04-20-00,Provider_ID:Phy777777,Patient_ID:Pa234567')
...
//		jmsService.send(queue:'PFM_Event','event:ConsultationCompleted1,timestamp:2011-11-11/04-40-00,Provider_ID:Phy777777,Patient_ID:Pa234567')
...
//		jmsService.send(queue:'PFM_Event','event:WaitForConsultation2,timestamp:2011-11-11/05-41-00,Patient_ID:Pa234567')
//		jmsService.send(queue:'PFM_Event','event:ConsultationStarted2,timestamp:2011-11-11/06-05-00,Provider_ID:Phy777777,Patient_ID:Pa234567')
...
//		jmsService.send(queue:'PFM_Event','event:ConsultationCompleted2,timestamp:2011-11-11/06-35-00,Provider_ID:Phy777777,Patient_ID:Pa234567')
...
//		jmsService.send(queue:'PFM_Event','event:PatientArrivedInBed,Unit_ID:CCU2,timestamp:2011-11-11/09-40-00,Bed_ID:Bed8,Patient_ID:Pa234567')		
	}
