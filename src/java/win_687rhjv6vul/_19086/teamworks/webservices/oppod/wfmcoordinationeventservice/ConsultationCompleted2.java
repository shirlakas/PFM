 ...
 *         &lt;element name="Physician_ID" type="{http://www.w3.org/2001/XMLSchema}string"/>
...
@XmlRootElement(name = "ConsultationCompleted2")
public class ConsultationCompleted2 {

    @XmlElement(name = "Patient_ID", required = true)
    protected String patientID;
    @XmlElement(name = "Physician_ID", required = true)
